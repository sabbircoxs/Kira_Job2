...
class AddProfileActivity_06 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_profile06)
        ...
        findViewById<Button>(R.id.addBtn).setOnClickListener {
            if (validateInputs(nameEditText, emailEditText, dobEditText, districtEditText, mobileEditText)) {
                ...
                val userProfile = UserProfile_06(name = name, email = email, dob = dob, district = district, mobile = mobile)
